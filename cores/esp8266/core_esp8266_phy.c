...
static const uint8_t ICACHE_FLASH_ATTR phy_init_data[128] =
{
    ...
    [34] = 78, // target_power_qdb_0, 82 means target power is 78/4=19.5dbm
    [35] = 74, // target_power_qdb_1, 78 means target power is 74/4=18.5dbm
    [36] = 70, // target_power_qdb_2, 74 means target power is 70/4=17.5dbm
    [37] = 64, // target_power_qdb_3, 68 means target power is 64/4=16dbm
    [38] = 60, // target_power_qdb_4, 64 means target power is 60/4=15dbm
